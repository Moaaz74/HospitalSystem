...
namespace HospitalSystem.Utilities
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public DbInitializer(UserManager<IdentityUser> _userManager  , RoleManager<IdentityRole> _roleManager,
        ...
        public void Initialize()
        {
            ...
            {
                roleManager.CreateAsync(new IdentityRole(SystemRoles.Admin));
                roleManager.CreateAsync(new IdentityRole(SystemRoles.Patient));
                roleManager.CreateAsync(new IdentityRole(SystemRoles.Doctor));
